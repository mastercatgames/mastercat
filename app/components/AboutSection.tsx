        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              Master Cat Game Studio was born from a passion for creating unique
              and memorable gaming experiences. As an indie studio, we believe
              in the power of creativity, innovation, and the magic that happens
              when you combine artistic vision with technical excellence.
            </p>
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              We're not just making games – we're crafting experiences that
              resonate with players, tell compelling stories, and push the
              boundaries of what indie games can achieve.
            </p>
